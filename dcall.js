...
function ToggleHamburger(_AuthEmail) {
    ...
    if (Doc.Elements.Hamburger.classList.contains("active")) {
        ProcessWhatsapp();
        Doc.Elements.PrintClaimLink.href = "https://" + Doc.URL.hostname + "/DPSWeb2/Report/_claim/" + Doc.Claim.REF + "?reporttype=claim";
        Doc.Elements.PrintClaimReport.href = "https://" + Doc.URL.hostname + "/DPSWeb2/Report/_claim/" + Doc.Claim.REF + "?reporttype=worksorder";
